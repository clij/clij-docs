...
Ext.CLIJ_create2D("cat", width, height, 32);
...
for (i = 0; i < 36; i++) {
	...
	for (c = 0; c < 3; c++) {
		...
		Ext.CLIJ_affineTransform2D("shiftY", "rotatedShiftY", "center translateX=" + (i * 20) + " translateY=" + (i * -10) + " -center");
